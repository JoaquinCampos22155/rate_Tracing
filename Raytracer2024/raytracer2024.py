...
rt.envMap = Texture("Raytracer2024/textures/backgrounds/parkingLot.bmp")
...
rt.lights.append(PointLight(position= [0,0,-5]))

#SPHERES--------------------------------
rt.scene.append(Sphere([-1, 0, -5], radius=1, material=brick))
...
#AABB----------------------------------
#rt.scene.append(AABB(position = [0,0,-5], sizes = [0.5,0.5,0.5], material = wood))
